...
public class PersonController {
     ...
     */
    public Person createPersonByRole(String id, String name, String lastName,String phone , String email,String role){
        ...
        switch (typePerson){
            ...
            case PROFESSOR, DIRECTOR:
                ...
                break;
            case ADMINISTRATOR:
                newPerson = new Administrator(id, name, lastName,phone, email);
                break;
            case SECRETARY:
